...
//Printing the details of I.T students at Ujhub
var print = ITstudents.filter((details)=> details);
...
var Allstudents = ITstudents.filter(function(val){
    if(MaxVal< val.Height){
        MaxVal = val.Height;
    }
});

//To collect the details of the person with the maximum height
var collect = ITstudents.filter(function(record){
    if(record.Height == MaxVal){
        return record;
    }
});
console.log("\n\nThis is the tallest person\n\n", collect);
 ...
 console.log("\n\n This is the student with the maximum avarage grade\n\n", ITstudents[ans]);
